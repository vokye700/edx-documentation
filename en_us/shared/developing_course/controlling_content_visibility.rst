...
earned a minimum score or completed a minimum portion in a prerequisite subsection, follow these steps.
...
#. To require that learners achieve a minimum score in the prerequisite
   subsection, enter the percent of the total score that learners must earn in
   the **Minimum Score** field. A learner's score for all problems in the
   prerequisite subsection must be equal to or greater than this percentage in
   order to satisfy the prerequisite and display the current subsection. If
   the prerequisite section is not a problem set, set the **Minimum Score** to
   ``0`` and set the  **Minimum Completion Percentage** field to a value
   greater than zero.
   ...
   section, enter the percent of the prerequisite section that learners must
   complete in the **Minimum Completion Percentage** field. A learner must
   complete at least this percentage of the prerequisite subsection in order
   to satisfy the prerequisite and display the current subsection.

   If you set both the **Minimum Score** field and the **Minimum Completion
   Percentage** field to a value greater than zero, then learners must satify
